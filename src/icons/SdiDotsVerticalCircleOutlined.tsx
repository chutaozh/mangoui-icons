...
const SdiDotsVerticalCircleOutlined: React.FC<BaseIconProps> = (props) => {
    const classes = cn('sdi-dots-vertical-circle', { [props.className || '']: !!props.className });
...
export default SdiDotsVerticalCircleOutlined;