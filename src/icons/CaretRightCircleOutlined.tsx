...
const CaretRightCircleOutlined: React.FC<BaseIconProps> = (props) => {
    const classes = cn('micon-caret-right-circle', props.className);
...
export default CaretRightCircleOutlined;