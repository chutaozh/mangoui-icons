...
const SdiPlusCircleOutlined: React.FC<BaseIconProps> = (props) => {
    const classes = cn('sdi-plus-circle', { [props.className || '']: !!props.className });
...
export default SdiPlusCircleOutlined;