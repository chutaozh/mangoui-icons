...
const SdiArrowLeftCircleFilled: React.FC<BaseIconProps> = (props) => {
    const classes = cn('sdi-arrow-left-circle', props.className);
...
export default SdiArrowLeftCircleFilled;