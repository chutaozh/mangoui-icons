...
const SdiUpSquareOutlined: React.FC<BaseIconProps> = (props) => {
    const classes = cn('sdi-up-square', { [props.className || '']: !!props.className });
...
export default SdiUpSquareOutlined;