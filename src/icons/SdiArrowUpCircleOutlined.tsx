...
const SdiArrowUpCircleOutlined: React.FC<BaseIconProps> = (props) => {
    const classes = cn('sdi-arrow-up-circle', props.className);
...
export default SdiArrowUpCircleOutlined;