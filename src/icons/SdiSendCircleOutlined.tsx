...
const SdiSendCircleOutlined: React.FC<BaseIconProps> = (props) => {
    const classes = cn('sdi-send-circle', { [props.className || '']: !!props.className });
...
export default SdiSendCircleOutlined;