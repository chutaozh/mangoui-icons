...
const ArrowUpThinCircleOutlined: React.FC<BaseIconProps> = (props) => {
    const classes = cn('micon-arrow-up-thin-circle', props.className);
...
export default ArrowUpThinCircleOutlined;