...
const SdiArrowDownCircleOutlined: React.FC<BaseIconProps> = (props) => {
    const classes = cn('sdi-arrow-down-circle', { [props.className || '']: !!props.className });
...
export default SdiArrowDownCircleOutlined;