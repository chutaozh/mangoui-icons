...
const SdiWarningCircleOutlined: React.FC<BaseIconProps> = (props) => {
    const classes = cn('sdi-warning-circle', { [props.className || '']: !!props.className });
...
export default SdiWarningCircleOutlined;