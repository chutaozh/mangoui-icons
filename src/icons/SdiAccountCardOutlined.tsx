...
const SdiAccountCardOutlined: React.FC<BaseIconProps> = (props) => {
    const classes = cn('sdi-account-card', { [props.className || '']: !!props.className });
...
export default SdiAccountCardOutlined;