...
const SdiEditSquareOutlined: React.FC<BaseIconProps> = (props) => {
    const classes = cn('sdi-edit-square', { [props.className || '']: !!props.className });
...
export default SdiEditSquareOutlined;