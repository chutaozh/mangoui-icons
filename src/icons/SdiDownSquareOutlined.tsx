...
const SdiDownSquareOutlined: React.FC<BaseIconProps> = (props) => {
    const classes = cn('sdi-down-square', { [props.className || '']: !!props.className });
...
export default SdiDownSquareOutlined;