...
const ArrowLeftThinCircleOutlined: React.FC<BaseIconProps> = (props) => {
    const classes = cn('micon-arrow-left-thin-circle', props.className);
...
export default ArrowLeftThinCircleOutlined;