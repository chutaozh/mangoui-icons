...
const SdiDotsHorizontalCircleOutlined: React.FC<BaseIconProps> = (props) => {
    const classes = cn('sdi-dots-horizontal-circle', { [props.className || '']: !!props.className });
...
export default SdiDotsHorizontalCircleOutlined;