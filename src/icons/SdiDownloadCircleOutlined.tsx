...
const SdiDownloadCircleOutlined: React.FC<BaseIconProps> = (props) => {
    const classes = cn('sdi-download-circle', { [props.className || '']: !!props.className });
...
export default SdiDownloadCircleOutlined;