...
const SdiMicrophoneFilled: React.FC<BaseIconProps> = (props) => {
    const classes = cn('sdi-microphone', { [props.className || '']: !!props.className });
...
export default SdiMicrophoneFilled;