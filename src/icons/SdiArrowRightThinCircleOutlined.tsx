...
const SdiArrowRightThinCircleOutlined: React.FC<BaseIconProps> = (props) => {
    const classes = cn('sdi-arrow-right-thin-circle', { [props.className || '']: !!props.className });
...
export default SdiArrowRightThinCircleOutlined;