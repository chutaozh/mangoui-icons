...
const SdiCommentProcessingOutlined: React.FC<BaseIconProps> = (props) => {
    const classes = cn('sdi-comment-processing', { [props.className || '']: !!props.className });
...
export default SdiCommentProcessingOutlined;